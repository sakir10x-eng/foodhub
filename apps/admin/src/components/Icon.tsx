...
export type IconName =
  ...
  | 'trash' | 'chevron-up' | 'chevron-down' | 'lock' | 'percent' | 'cash';
...
const PATHS: Record<IconName, string> = {
  ...
  percent: 'M19 5 5 19M7.5 9.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Zm9 10a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z',
